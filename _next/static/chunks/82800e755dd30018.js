(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,7234,e=>{"use strict";var t=e.i(43476),a=e.i(19455),o=e.i(76639),i=e.i(71645);function n(){let[e,n]=(0,i.useState)(!1);return(0,i.useEffect)(()=>{if(!localStorage.getItem("cookie-consent")){let e=setTimeout(()=>n(!0),1e3);return()=>clearTimeout(e)}},[]),(0,t.jsx)(o.Dialog,{open:e,onOpenChange:n,children:(0,t.jsxs)(o.DialogContent,{className:"glass-card sm:max-w-md border-0 fixed bottom-4 right-4 left-4 sm:left-auto translate-y-0 translate-x-0 top-auto animate-in slide-in-from-bottom-5 duration-500 rounded-2xl shadow-2xl backdrop-blur-2xl",children:[(0,t.jsxs)(o.DialogHeader,{children:[(0,t.jsx)(o.DialogTitle,{className:"text-lg font-bold",children:"Privacy Choices"}),(0,t.jsx)(o.DialogDescription,{className:"text-muted-foreground",children:"We use cookies to personalize content and ads, provide social media features, and analyze our traffic. We share these insights with our advertising and analytics partners."})]}),(0,t.jsxs)(o.DialogFooter,{className:"sm:justify-start flex-col gap-2",children:[(0,t.jsxs)("div",{className:"flex gap-2 w-full",children:[(0,t.jsx)(a.Button,{type:"button",variant:"secondary",className:"flex-1",onClick:()=>{localStorage.setItem("cookie-consent","declined"),window.dispatchEvent(new CustomEvent("cookie-consent",{detail:"declined"})),n(!1)},children:"Essential Only"}),(0,t.jsx)(a.Button,{type:"button",className:"flex-1 bg-primary hover:bg-primary/90",onClick:()=>{localStorage.setItem("cookie-consent","accepted"),window.dispatchEvent(new CustomEvent("cookie-consent",{detail:"accepted"})),n(!1)},children:"Accept All"})]}),(0,t.jsx)(a.Button,{variant:"link",className:"text-xs h-auto p-0 text-muted-foreground",onClick:()=>window.open("/privacy","_blank"),children:"View Privacy Policy"})]})]})})}e.s(["CookieConsent",()=>n])},18566,(e,t,a)=>{t.exports=e.r(76562)},65890,e=>{"use strict";let t,a,o,i,n,s;var r=e.i(43476),l=e.i(75254);let h=(0,l.default)("chevrons-up-down",[["path",{d:"m7 15 5 5 5-5",key:"1hf1tw"}],["path",{d:"m7 9 5-5 5 5",key:"sgt6xg"}]]),u=(0,l.default)("search",[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]]);var d=e.i(18566),c=e.i(71645),p=e.i(19455),m=/[\\\/_+.#"@\[\(\{&]/,y=/[\\\/_+.#"@\[\(\{&]/g,g=/[\s-]/,f=/[\s-]/g;function w(e){return e.toLowerCase().replace(f," ")}var b=e.i(26999),v=e.i(48425),k=e.i(10772),T=e.i(20783),x='[cmdk-group=""]',I='[cmdk-group-items=""]',S='[cmdk-item=""]',A=`${S}:not([aria-disabled="true"])`,C="cmdk-item-select",q="data-value",W=(e,t,a)=>{var o;return o=e,function e(t,a,o,i,n,s,r){if(s===a.length)return n===t.length?1:.99;var l=`${n},${s}`;if(void 0!==r[l])return r[l];for(var h,u,d,c,p=i.charAt(s),w=o.indexOf(p,n),b=0;w>=0;)(h=e(t,a,o,i,w+1,s+1,r))>b&&(w===n?h*=1:m.test(t.charAt(w-1))?(h*=.8,(d=t.slice(n,w-1).match(y))&&n>0&&(h*=Math.pow(.999,d.length))):g.test(t.charAt(w-1))?(h*=.9,(c=t.slice(n,w-1).match(f))&&n>0&&(h*=Math.pow(.999,c.length))):(h*=.17,n>0&&(h*=Math.pow(.999,w-n))),t.charAt(w)!==a.charAt(s)&&(h*=.9999)),(h<.1&&o.charAt(w-1)===i.charAt(s+1)||i.charAt(s+1)===i.charAt(s)&&o.charAt(w-1)!==i.charAt(s))&&.1*(u=e(t,a,o,i,w+1,s+2,r))>h&&(h=.1*u),h>b&&(b=h),w=o.indexOf(p,w+1);return r[l]=b,b}(o=a&&a.length>0?`${o+" "+a.join(" ")}`:o,t,w(o),w(t),0,0,{})},E=c.createContext(void 0),M=c.createContext(void 0),j=c.createContext(void 0),R=c.forwardRef((e,t)=>{let a=Y(()=>{var t,a;return{search:"",value:null!=(a=null!=(t=e.value)?t:e.defaultValue)?a:"",selectedItemId:void 0,filtered:{count:0,items:new Map,groups:new Set}}}),o=Y(()=>new Set),i=Y(()=>new Map),n=Y(()=>new Map),s=Y(()=>new Set),r=O(e),{label:l,children:h,value:u,onValueChange:d,filter:p,shouldFilter:m,loop:y,disablePointerSelection:g=!1,vimBindings:f=!0,...w}=e,b=(0,k.useId)(),T=(0,k.useId)(),j=(0,k.useId)(),R=c.useRef(null),P=_();L(()=>{if(void 0!==u){let e=u.trim();a.current.value=e,z.emit()}},[u]),L(()=>{P(6,G)},[]);let z=c.useMemo(()=>({subscribe:e=>(s.current.add(e),()=>s.current.delete(e)),snapshot:()=>a.current,setState:(e,t,o)=>{var i,n,s,l;if(!Object.is(a.current[e],t)){if(a.current[e]=t,"search"===e)F(),N(),P(1,B);else if("value"===e){if(document.activeElement.hasAttribute("cmdk-input")||document.activeElement.hasAttribute("cmdk-root")){let e=document.getElementById(j);e?e.focus():null==(i=document.getElementById(b))||i.focus()}if(P(7,()=>{var e;a.current.selectedItemId=null==(e=U())?void 0:e.id,z.emit()}),o||P(5,G),(null==(n=r.current)?void 0:n.value)!==void 0){null==(l=(s=r.current).onValueChange)||l.call(s,null!=t?t:"");return}}z.emit()}},emit:()=>{s.current.forEach(e=>e())}}),[]),H=c.useMemo(()=>({value:(e,t,o)=>{var i;t!==(null==(i=n.current.get(e))?void 0:i.value)&&(n.current.set(e,{value:t,keywords:o}),a.current.filtered.items.set(e,D(t,o)),P(2,()=>{N(),z.emit()}))},item:(e,t)=>(o.current.add(e),t&&(i.current.has(t)?i.current.get(t).add(e):i.current.set(t,new Set([e]))),P(3,()=>{F(),N(),a.current.value||B(),z.emit()}),()=>{n.current.delete(e),o.current.delete(e),a.current.filtered.items.delete(e);let t=U();P(4,()=>{F(),(null==t?void 0:t.getAttribute("id"))===e&&B(),z.emit()})}),group:e=>(i.current.has(e)||i.current.set(e,new Set),()=>{n.current.delete(e),i.current.delete(e)}),filter:()=>r.current.shouldFilter,label:l||e["aria-label"],getDisablePointerSelection:()=>r.current.disablePointerSelection,listId:b,inputId:j,labelId:T,listInnerRef:R}),[]);function D(e,t){var o,i;let n=null!=(i=null==(o=r.current)?void 0:o.filter)?i:W;return e?n(e,a.current.search,t):0}function N(){if(!a.current.search||!1===r.current.shouldFilter)return;let e=a.current.filtered.items,t=[];a.current.filtered.groups.forEach(a=>{let o=i.current.get(a),n=0;o.forEach(t=>{n=Math.max(e.get(t),n)}),t.push([a,n])});let o=R.current;K().sort((t,a)=>{var o,i;let n=t.getAttribute("id"),s=a.getAttribute("id");return(null!=(o=e.get(s))?o:0)-(null!=(i=e.get(n))?i:0)}).forEach(e=>{let t=e.closest(I);t?t.appendChild(e.parentElement===t?e:e.closest(`${I} > *`)):o.appendChild(e.parentElement===o?e:e.closest(`${I} > *`))}),t.sort((e,t)=>t[1]-e[1]).forEach(e=>{var t;let a=null==(t=R.current)?void 0:t.querySelector(`${x}[${q}="${encodeURIComponent(e[0])}"]`);null==a||a.parentElement.appendChild(a)})}function B(){let e=K().find(e=>"true"!==e.getAttribute("aria-disabled")),t=null==e?void 0:e.getAttribute(q);z.setState("value",t||void 0)}function F(){var e,t,s,l;if(!a.current.search||!1===r.current.shouldFilter){a.current.filtered.count=o.current.size;return}a.current.filtered.groups=new Set;let h=0;for(let i of o.current){let o=D(null!=(t=null==(e=n.current.get(i))?void 0:e.value)?t:"",null!=(l=null==(s=n.current.get(i))?void 0:s.keywords)?l:[]);a.current.filtered.items.set(i,o),o>0&&h++}for(let[e,t]of i.current)for(let o of t)if(a.current.filtered.items.get(o)>0){a.current.filtered.groups.add(e);break}a.current.filtered.count=h}function G(){var e,t,a;let o=U();o&&((null==(e=o.parentElement)?void 0:e.firstChild)===o&&(null==(a=null==(t=o.closest(x))?void 0:t.querySelector('[cmdk-group-heading=""]'))||a.scrollIntoView({block:"nearest"})),o.scrollIntoView({block:"nearest"}))}function U(){var e;return null==(e=R.current)?void 0:e.querySelector(`${S}[aria-selected="true"]`)}function K(){var e;return Array.from((null==(e=R.current)?void 0:e.querySelectorAll(A))||[])}function J(e){let t=K()[e];t&&z.setState("value",t.getAttribute(q))}function Z(e){var t;let a=U(),o=K(),i=o.findIndex(e=>e===a),n=o[i+e];null!=(t=r.current)&&t.loop&&(n=i+e<0?o[o.length-1]:i+e===o.length?o[0]:o[i+e]),n&&z.setState("value",n.getAttribute(q))}function Q(e){let t=U(),a=null==t?void 0:t.closest(x),o;for(;a&&!o;)o=null==(a=e>0?function(e,t){let a=e.nextElementSibling;for(;a;){if(a.matches(t))return a;a=a.nextElementSibling}}(a,x):function(e,t){let a=e.previousElementSibling;for(;a;){if(a.matches(t))return a;a=a.previousElementSibling}}(a,x))?void 0:a.querySelector(A);o?z.setState("value",o.getAttribute(q)):Z(e)}let X=()=>J(K().length-1),ee=e=>{e.preventDefault(),e.metaKey?X():e.altKey?Q(1):Z(1)},et=e=>{e.preventDefault(),e.metaKey?J(0):e.altKey?Q(-1):Z(-1)};return c.createElement(v.Primitive.div,{ref:t,tabIndex:-1,...w,"cmdk-root":"",onKeyDown:e=>{var t;null==(t=w.onKeyDown)||t.call(w,e);let a=e.nativeEvent.isComposing||229===e.keyCode;if(!(e.defaultPrevented||a))switch(e.key){case"n":case"j":f&&e.ctrlKey&&ee(e);break;case"ArrowDown":ee(e);break;case"p":case"k":f&&e.ctrlKey&&et(e);break;case"ArrowUp":et(e);break;case"Home":e.preventDefault(),J(0);break;case"End":e.preventDefault(),X();break;case"Enter":{e.preventDefault();let t=U();if(t){let e=new Event(C);t.dispatchEvent(e)}}}}},c.createElement("label",{"cmdk-label":"",htmlFor:H.inputId,id:H.labelId,style:V},l),$(e,e=>c.createElement(M.Provider,{value:z},c.createElement(E.Provider,{value:H},e))))}),P=c.forwardRef((e,t)=>{var a,o;let i=(0,k.useId)(),n=c.useRef(null),s=c.useContext(j),r=c.useContext(E),l=O(e),h=null!=(o=null==(a=l.current)?void 0:a.forceMount)?o:null==s?void 0:s.forceMount;L(()=>{if(!h)return r.item(i,null==s?void 0:s.id)},[h]);let u=U(i,n,[e.value,e.children,n],e.keywords),d=c.useContext(M),p=G(e=>e.value&&e.value===u.current),m=G(e=>!!h||!1===r.filter()||!e.search||e.filtered.items.get(i)>0);function y(){var e,t;g(),null==(t=(e=l.current).onSelect)||t.call(e,u.current)}function g(){d.setState("value",u.current,!0)}if(c.useEffect(()=>{let t=n.current;if(!(!t||e.disabled))return t.addEventListener(C,y),()=>t.removeEventListener(C,y)},[m,e.onSelect,e.disabled]),!m)return null;let{disabled:f,value:w,onSelect:b,forceMount:x,keywords:I,...S}=e;return c.createElement(v.Primitive.div,{ref:(0,T.composeRefs)(n,t),...S,id:i,"cmdk-item":"",role:"option","aria-disabled":!!f,"aria-selected":!!p,"data-disabled":!!f,"data-selected":!!p,onPointerMove:f||r.getDisablePointerSelection()?void 0:g,onClick:f?void 0:y},e.children)}),z=c.forwardRef((e,t)=>{let{heading:a,children:o,forceMount:i,...n}=e,s=(0,k.useId)(),r=c.useRef(null),l=c.useRef(null),h=(0,k.useId)(),u=c.useContext(E),d=G(e=>!!i||!1===u.filter()||!e.search||e.filtered.groups.has(s));L(()=>u.group(s),[]),U(s,r,[e.value,e.heading,l]);let p=c.useMemo(()=>({id:s,forceMount:i}),[i]);return c.createElement(v.Primitive.div,{ref:(0,T.composeRefs)(r,t),...n,"cmdk-group":"",role:"presentation",hidden:!d||void 0},a&&c.createElement("div",{ref:l,"cmdk-group-heading":"","aria-hidden":!0,id:h},a),$(e,e=>c.createElement("div",{"cmdk-group-items":"",role:"group","aria-labelledby":a?h:void 0},c.createElement(j.Provider,{value:p},e))))}),H=c.forwardRef((e,t)=>{let{alwaysRender:a,...o}=e,i=c.useRef(null),n=G(e=>!e.search);return a||n?c.createElement(v.Primitive.div,{ref:(0,T.composeRefs)(i,t),...o,"cmdk-separator":"",role:"separator"}):null}),D=c.forwardRef((e,t)=>{let{onValueChange:a,...o}=e,i=null!=e.value,n=c.useContext(M),s=G(e=>e.search),r=G(e=>e.selectedItemId),l=c.useContext(E);return c.useEffect(()=>{null!=e.value&&n.setState("search",e.value)},[e.value]),c.createElement(v.Primitive.input,{ref:t,...o,"cmdk-input":"",autoComplete:"off",autoCorrect:"off",spellCheck:!1,"aria-autocomplete":"list",role:"combobox","aria-expanded":!0,"aria-controls":l.listId,"aria-labelledby":l.labelId,"aria-activedescendant":r,id:l.inputId,type:"text",value:i?e.value:s,onChange:e=>{i||n.setState("search",e.target.value),null==a||a(e.target.value)}})}),N=c.forwardRef((e,t)=>{let{children:a,label:o="Suggestions",...i}=e,n=c.useRef(null),s=c.useRef(null),r=G(e=>e.selectedItemId),l=c.useContext(E);return c.useEffect(()=>{if(s.current&&n.current){let e=s.current,t=n.current,a,o=new ResizeObserver(()=>{a=requestAnimationFrame(()=>{let a=e.offsetHeight;t.style.setProperty("--cmdk-list-height",a.toFixed(1)+"px")})});return o.observe(e),()=>{cancelAnimationFrame(a),o.unobserve(e)}}},[]),c.createElement(v.Primitive.div,{ref:(0,T.composeRefs)(n,t),...i,"cmdk-list":"",role:"listbox",tabIndex:-1,"aria-activedescendant":r,"aria-label":o,id:l.listId},$(e,e=>c.createElement("div",{ref:(0,T.composeRefs)(s,l.listInnerRef),"cmdk-list-sizer":""},e)))}),B=c.forwardRef((e,t)=>{let{open:a,onOpenChange:o,overlayClassName:i,contentClassName:n,container:s,...r}=e;return c.createElement(b.Root,{open:a,onOpenChange:o},c.createElement(b.Portal,{container:s},c.createElement(b.Overlay,{"cmdk-overlay":"",className:i}),c.createElement(b.Content,{"aria-label":e.label,"cmdk-dialog":"",className:n},c.createElement(R,{ref:t,...r}))))}),F=Object.assign(R,{List:N,Item:P,Input:D,Group:z,Separator:H,Dialog:B,Empty:c.forwardRef((e,t)=>G(e=>0===e.filtered.count)?c.createElement(v.Primitive.div,{ref:t,...e,"cmdk-empty":"",role:"presentation"}):null),Loading:c.forwardRef((e,t)=>{let{progress:a,children:o,label:i="Loading...",...n}=e;return c.createElement(v.Primitive.div,{ref:t,...n,"cmdk-loading":"",role:"progressbar","aria-valuenow":a,"aria-valuemin":0,"aria-valuemax":100,"aria-label":i},$(e,e=>c.createElement("div",{"aria-hidden":!0},e)))})});function O(e){let t=c.useRef(e);return L(()=>{t.current=e}),t}var L="u"<typeof window?c.useEffect:c.useLayoutEffect;function Y(e){let t=c.useRef();return void 0===t.current&&(t.current=e()),t}function G(e){let t=c.useContext(M),a=()=>e(t.snapshot());return c.useSyncExternalStore(t.subscribe,a,a)}function U(e,t,a,o=[]){let i=c.useRef(),n=c.useContext(E);return L(()=>{var s;let r=(()=>{var e;for(let t of a){if("string"==typeof t)return t.trim();if("object"==typeof t&&"current"in t)return t.current?null==(e=t.current.textContent)?void 0:e.trim():i.current}})(),l=o.map(e=>e.trim());n.value(e,r,l),null==(s=t.current)||s.setAttribute(q,r),i.current=r}),i}var _=()=>{let[e,t]=c.useState(),a=Y(()=>new Map);return L(()=>{a.current.forEach(e=>e()),a.current=new Map},[e]),(e,o)=>{a.current.set(e,o),t({})}};function $({asChild:e,children:t},a){let o;return e&&c.isValidElement(t)?c.cloneElement("function"==typeof(o=t.type)?o(t.props):"render"in o?o.render(t.props):t,{ref:t.ref},a(t.props.children)):a(t)}var V={position:"absolute",width:"1px",height:"1px",padding:"0",margin:"-1px",overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",borderWidth:"0"},K=e.i(75157);function J({className:e,...t}){return(0,r.jsx)(F,{"data-slot":"command",className:(0,K.cn)("bg-popover text-popover-foreground flex h-full w-full flex-col overflow-hidden rounded-md",e),...t})}function Z({className:e,...t}){return(0,r.jsxs)("div",{"data-slot":"command-input-wrapper",className:"flex h-9 items-center gap-2 border-b px-3",children:[(0,r.jsx)(u,{className:"size-4 shrink-0 opacity-50"}),(0,r.jsx)(F.Input,{"data-slot":"command-input",className:(0,K.cn)("placeholder:text-muted-foreground flex h-10 w-full rounded-md bg-transparent py-3 text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50",e),...t})]})}function Q({className:e,...t}){return(0,r.jsx)(F.List,{"data-slot":"command-list",className:(0,K.cn)("max-h-[300px] scroll-py-1 overflow-x-hidden overflow-y-auto",e),...t})}function X({...e}){return(0,r.jsx)(F.Empty,{"data-slot":"command-empty",className:"py-6 text-center text-sm",...e})}function ee({className:e,...t}){return(0,r.jsx)(F.Group,{"data-slot":"command-group",className:(0,K.cn)("text-foreground [&_[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium",e),...t})}function et({className:e,...t}){return(0,r.jsx)(F.Item,{"data-slot":"command-item",className:(0,K.cn)("data-[selected=true]:bg-accent data-[selected=true]:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",e),...t})}e.i(76639);var ea=e.i(81140),eo=e.i(30030),ei=e.i(26330),en=e.i(3536),es=e.i(65491),er=e.i(53660),el=e.i(74606),eh=e.i(96626),eu=Symbol("radix.slottable");function ed(e){return c.isValidElement(e)&&"function"==typeof e.type&&"__radixId"in e.type&&e.type.__radixId===eu}var ec=e.i(69340),ep=e.i(86312),em=e.i(85369),ey="Popover",[eg,ef]=(0,eo.createContextScope)(ey,[er.createPopperScope]),ew=(0,er.createPopperScope)(),[eb,ev]=eg(ey),ek=e=>{let{__scopePopover:t,children:a,open:o,defaultOpen:i,onOpenChange:n,modal:s=!1}=e,l=ew(t),h=c.useRef(null),[u,d]=c.useState(!1),[p,m]=(0,ec.useControllableState)({prop:o,defaultProp:i??!1,onChange:n,caller:ey});return(0,r.jsx)(er.Root,{...l,children:(0,r.jsx)(eb,{scope:t,contentId:(0,k.useId)(),triggerRef:h,open:p,onOpenChange:m,onOpenToggle:c.useCallback(()=>m(e=>!e),[m]),hasCustomAnchor:u,onCustomAnchorAdd:c.useCallback(()=>d(!0),[]),onCustomAnchorRemove:c.useCallback(()=>d(!1),[]),modal:s,children:a})})};ek.displayName=ey;var eT="PopoverAnchor";c.forwardRef((e,t)=>{let{__scopePopover:a,...o}=e,i=ev(eT,a),n=ew(a),{onCustomAnchorAdd:s,onCustomAnchorRemove:l}=i;return c.useEffect(()=>(s(),()=>l()),[s,l]),(0,r.jsx)(er.Anchor,{...n,...o,ref:t})}).displayName=eT;var ex="PopoverTrigger",eI=c.forwardRef((e,t)=>{let{__scopePopover:a,...o}=e,i=ev(ex,a),n=ew(a),s=(0,T.useComposedRefs)(t,i.triggerRef),l=(0,r.jsx)(v.Primitive.button,{type:"button","aria-haspopup":"dialog","aria-expanded":i.open,"aria-controls":i.contentId,"data-state":eH(i.open),...o,ref:s,onClick:(0,ea.composeEventHandlers)(e.onClick,i.onOpenToggle)});return i.hasCustomAnchor?l:(0,r.jsx)(er.Anchor,{asChild:!0,...n,children:l})});eI.displayName=ex;var eS="PopoverPortal",[eA,eC]=eg(eS,{forceMount:void 0}),eq=e=>{let{__scopePopover:t,forceMount:a,children:o,container:i}=e,n=ev(eS,t);return(0,r.jsx)(eA,{scope:t,forceMount:a,children:(0,r.jsx)(eh.Presence,{present:a||n.open,children:(0,r.jsx)(el.Portal,{asChild:!0,container:i,children:o})})})};eq.displayName=eS;var eW="PopoverContent",eE=c.forwardRef((e,t)=>{let a=eC(eW,e.__scopePopover),{forceMount:o=a.forceMount,...i}=e,n=ev(eW,e.__scopePopover);return(0,r.jsx)(eh.Presence,{present:o||n.open,children:n.modal?(0,r.jsx)(ej,{...i,ref:t}):(0,r.jsx)(eR,{...i,ref:t})})});eE.displayName=eW;var eM=((n=c.forwardRef((e,t)=>{let{children:a,...o}=e;if(c.isValidElement(a)){var i;let e,n,s=(i=a,(n=(e=Object.getOwnPropertyDescriptor(i.props,"ref")?.get)&&"isReactWarning"in e&&e.isReactWarning)?i.ref:(n=(e=Object.getOwnPropertyDescriptor(i,"ref")?.get)&&"isReactWarning"in e&&e.isReactWarning)?i.props.ref:i.props.ref||i.ref),r=function(e,t){let a={...t};for(let o in t){let i=e[o],n=t[o];/^on[A-Z]/.test(o)?i&&n?a[o]=(...e)=>{let t=n(...e);return i(...e),t}:i&&(a[o]=i):"style"===o?a[o]={...i,...n}:"className"===o&&(a[o]=[i,n].filter(Boolean).join(" "))}return{...e,...a}}(o,a.props);return a.type!==c.Fragment&&(r.ref=t?(0,T.composeRefs)(t,s):s),c.cloneElement(a,r)}return c.Children.count(a)>1?c.Children.only(null):null})).displayName="PopoverContent.RemoveScroll.SlotClone",t=n,(a=c.forwardRef((e,a)=>{let{children:o,...i}=e,n=c.Children.toArray(o),s=n.find(ed);if(s){let e=s.props.children,o=n.map(t=>t!==s?t:c.Children.count(e)>1?c.Children.only(null):c.isValidElement(e)?e.props.children:null);return(0,r.jsx)(t,{...i,ref:a,children:c.isValidElement(e)?c.cloneElement(e,void 0,o):null})}return(0,r.jsx)(t,{...i,ref:a,children:o})})).displayName="PopoverContent.RemoveScroll.Slot",a),ej=c.forwardRef((e,t)=>{let a=ev(eW,e.__scopePopover),o=c.useRef(null),i=(0,T.useComposedRefs)(t,o),n=c.useRef(!1);return c.useEffect(()=>{let e=o.current;if(e)return(0,ep.hideOthers)(e)},[]),(0,r.jsx)(em.RemoveScroll,{as:eM,allowPinchZoom:!0,children:(0,r.jsx)(eP,{...e,ref:i,trapFocus:a.open,disableOutsidePointerEvents:!0,onCloseAutoFocus:(0,ea.composeEventHandlers)(e.onCloseAutoFocus,e=>{e.preventDefault(),n.current||a.triggerRef.current?.focus()}),onPointerDownOutside:(0,ea.composeEventHandlers)(e.onPointerDownOutside,e=>{let t=e.detail.originalEvent,a=0===t.button&&!0===t.ctrlKey;n.current=2===t.button||a},{checkForDefaultPrevented:!1}),onFocusOutside:(0,ea.composeEventHandlers)(e.onFocusOutside,e=>e.preventDefault(),{checkForDefaultPrevented:!1})})})}),eR=c.forwardRef((e,t)=>{let a=ev(eW,e.__scopePopover),o=c.useRef(!1),i=c.useRef(!1);return(0,r.jsx)(eP,{...e,ref:t,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:t=>{e.onCloseAutoFocus?.(t),t.defaultPrevented||(o.current||a.triggerRef.current?.focus(),t.preventDefault()),o.current=!1,i.current=!1},onInteractOutside:t=>{e.onInteractOutside?.(t),t.defaultPrevented||(o.current=!0,"pointerdown"===t.detail.originalEvent.type&&(i.current=!0));let n=t.target;a.triggerRef.current?.contains(n)&&t.preventDefault(),"focusin"===t.detail.originalEvent.type&&i.current&&t.preventDefault()}})}),eP=c.forwardRef((e,t)=>{let{__scopePopover:a,trapFocus:o,onOpenAutoFocus:i,onCloseAutoFocus:n,disableOutsidePointerEvents:s,onEscapeKeyDown:l,onPointerDownOutside:h,onFocusOutside:u,onInteractOutside:d,...c}=e,p=ev(eW,a),m=ew(a);return(0,en.useFocusGuards)(),(0,r.jsx)(es.FocusScope,{asChild:!0,loop:!0,trapped:o,onMountAutoFocus:i,onUnmountAutoFocus:n,children:(0,r.jsx)(ei.DismissableLayer,{asChild:!0,disableOutsidePointerEvents:s,onInteractOutside:d,onEscapeKeyDown:l,onPointerDownOutside:h,onFocusOutside:u,onDismiss:()=>p.onOpenChange(!1),children:(0,r.jsx)(er.Content,{"data-state":eH(p.open),role:"dialog",id:p.contentId,...m,...c,ref:t,style:{...c.style,"--radix-popover-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-popover-content-available-width":"var(--radix-popper-available-width)","--radix-popover-content-available-height":"var(--radix-popper-available-height)","--radix-popover-trigger-width":"var(--radix-popper-anchor-width)","--radix-popover-trigger-height":"var(--radix-popper-anchor-height)"}})})})}),ez="PopoverClose";function eH(e){return e?"open":"closed"}function eD({...e}){return(0,r.jsx)(ek,{"data-slot":"popover",...e})}function eN({...e}){return(0,r.jsx)(eI,{"data-slot":"popover-trigger",...e})}function eB({className:e,align:t="center",sideOffset:a=4,...o}){return(0,r.jsx)(eq,{children:(0,r.jsx)(eE,{"data-slot":"popover-content",align:t,sideOffset:a,className:(0,K.cn)("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-72 origin-(--radix-popover-content-transform-origin) rounded-md border p-4 shadow-md outline-hidden",e),...o})})}c.forwardRef((e,t)=>{let{__scopePopover:a,...o}=e,i=ev(ez,a);return(0,r.jsx)(v.Primitive.button,{type:"button",...o,ref:t,onClick:(0,ea.composeEventHandlers)(e.onClick,()=>i.onOpenChange(!1))})}).displayName=ez,c.forwardRef((e,t)=>{let{__scopePopover:a,...o}=e,i=ew(a);return(0,r.jsx)(er.Arrow,{...i,...o,ref:t})}).displayName="PopoverArrow";let eF=[{id:"bigkidmath",name:"Big Kid Math",emoji:"🧠",tagline:"Adult Life Tools",description:"Real adulting decisions focused calculators.",gradientColor:"from-blue-500/20 to-cyan-500/20",borderHover:"group-hover:border-blue-500/50",navColor:"text-blue-500",navBg:"bg-blue-500/10"},{id:"cipherlab",name:"Cipher Lab",emoji:"🔐",tagline:"Codes & Security",description:"Tools for encryption, codes, and digital security.",gradientColor:"from-green-500/20 to-emerald-500/20",borderHover:"group-hover:border-green-500/50",navColor:"text-emerald-500",navBg:"bg-emerald-500/10"},{id:"geekgalaxy",name:"Geek Galaxy",emoji:"🧛",tagline:"Sci-Fi & Survival",description:"Sci-fi scenarios and pop culture survival tools.",gradientColor:"from-purple-500/20 to-pink-500/20",borderHover:"group-hover:border-purple-500/50",navColor:"text-yellow-500",navBg:"bg-yellow-500/10"},{id:"lifehacks",name:"Life Hacks",emoji:"🧬",tagline:"Optimize Life",description:"Optimization tools for everyday efficiency.",gradientColor:"from-yellow-500/20 to-orange-500/20",borderHover:"group-hover:border-yellow-500/50",navColor:"text-amber-500",navBg:"bg-amber-500/10"},{id:"mathmagik",name:"Math Magik",emoji:"🔮",tagline:"Fun with Numbers",description:"Playful exploration of numbers and patterns.",gradientColor:"from-indigo-500/20 to-violet-500/20",borderHover:"group-hover:border-indigo-500/50",navColor:"text-purple-500",navBg:"bg-purple-500/10"},{id:"otakuops",name:"Otaku Ops",emoji:"🐱‍👤",tagline:"Anime & Gaming",description:"Calculators for anime, manga, and gaming fans.",gradientColor:"from-red-500/20 to-rose-500/20",borderHover:"group-hover:border-red-500/50",navColor:"text-rose-500",navBg:"bg-rose-500/10"},{id:"brainmodes",name:"Brain Modes",emoji:"🧠",tagline:"Neurodivergence",description:"Calculators used to validate your neurodivergent experience.",gradientColor:"from-teal-500/20 to-cyan-500/20",borderHover:"group-hover:border-teal-500/50",navColor:"text-teal-500",navBg:"bg-teal-500/10"}],eO=[{id:"caffeine-half-life",title:"Caffeine Half-Life Calculator",description:"Track your caffeine metabolism with scientific accuracy.",category:"bigkidmath",slug:"caffeine-half-life",icon:"☕",origin:"Caffeine has a biological half-life of about 5-6 hours for the average adult. This tool uses standard pharmacokinetic models to estimate how much 'buzz' remains in your system.",howTo:"Enter the time and amount of your last coffee. We'll chart the decay curve and tell you when it's safe to sleep without that 'caffeine-crash' insomnia.",tips:["Genetics can make you a 'fast' or 'slow' metabolizer.","Smoking can double the speed of caffeine metabolism.","Grapefruit juice can actually slow it down!"],tags:["Health","Science"],content:`
...
`,faq:[{question:"Can I retrain my ears?",answer:"No. Once the hair cells are gone, they are gone. Protect what you have left by avoiding loud concerts (or wearing plugs)."},{question:"Is my phone speaker good enough?",answer:"Maybe. Most phone speakers roll off around 16kHz. High-quality headphones are needed for the 20kHz test."},{question:"What is 20kHz?",answer:"The theoretical upper limit of human hearing. Anything above that is ultrasonic (bats and dolphins)."}],relatedCalculators:["decibel-detective","visual-noise","stress-ice-cream"]}];function eL(){let[e,t]=c.useState(!1),[a,o]=c.useState(""),i=(0,d.useRouter)();return(0,r.jsxs)(eD,{open:e,onOpenChange:t,children:[(0,r.jsx)(eN,{asChild:!0,children:(0,r.jsxs)(p.Button,{variant:"outline",role:"combobox","aria-expanded":e,"aria-label":"Search calculators",className:"w-9 px-0 justify-center sm:w-[180px] sm:px-4 sm:justify-between lg:w-[300px] text-muted-foreground bg-background/50 border-input/50 hover:bg-accent/50",children:[(0,r.jsxs)("span",{className:"flex items-center gap-2 truncate",children:[(0,r.jsx)(u,{className:"h-4 w-4 opacity-50 shrink-0"}),(0,r.jsx)("span",{className:"hidden sm:inline truncate",children:a?eO.find(e=>e.title===a)?.title:"Search calculators..."})]}),(0,r.jsx)(h,{className:"ml-2 h-4 w-4 shrink-0 opacity-50 hidden sm:block"})]})}),(0,r.jsx)(eB,{className:"w-[200px] lg:w-[300px] p-0 glass-card",children:(0,r.jsxs)(J,{children:[(0,r.jsx)(Z,{placeholder:"Search tools..."}),(0,r.jsxs)(Q,{children:[(0,r.jsx)(X,{children:"No results found."}),(0,r.jsx)(ee,{heading:"Suggestions",children:eO.map(e=>(0,r.jsxs)(et,{value:`${e.title} ${e.tags?.join(" ")}`,onSelect:()=>{o(e.title),t(!1),i.push(`/calculators/${e.category}/${e.slug}`)},children:[(0,r.jsx)("span",{className:"mr-2",children:e.icon}),e.title]},e.id))})]})]})})]})}var eY=e.i(75830),eG=e.i(86318),eU=e.i(42727),e_=Symbol("radix.slottable");function e$(e){return c.isValidElement(e)&&"function"==typeof e.type&&"__radixId"in e.type&&e.type.__radixId===e_}var eV=e.i(30207),eK=["Enter"," "],eJ=["ArrowUp","PageDown","End"],eZ=["ArrowDown","PageUp","Home",...eJ],eQ={ltr:[...eK,"ArrowRight"],rtl:[...eK,"ArrowLeft"]},eX={ltr:["ArrowLeft"],rtl:["ArrowRight"]},e0="Menu",[e1,e5,e2]=(0,eY.createCollection)(e0),[e3,e4]=(0,eo.createContextScope)(e0,[e2,er.createPopperScope,eU.createRovingFocusGroupScope]),e9=(0,er.createPopperScope)(),e6=(0,eU.createRovingFocusGroupScope)(),[e8,e7]=e3(e0),[te,tt]=e3(e0),ta=e=>{let{__scopeMenu:t,open:a=!1,children:o,dir:i,onOpenChange:n,modal:s=!0}=e,l=e9(t),[h,u]=c.useState(null),d=c.useRef(!1),p=(0,eV.useCallbackRef)(n),m=(0,eG.useDirection)(i);return c.useEffect(()=>{let e=()=>{d.current=!0,document.addEventListener("pointerdown",t,{capture:!0,once:!0}),document.addEventListener("pointermove",t,{capture:!0,once:!0})},t=()=>d.current=!1;return document.addEventListener("keydown",e,{capture:!0}),()=>{document.removeEventListener("keydown",e,{capture:!0}),document.removeEventListener("pointerdown",t,{capture:!0}),document.removeEventListener("pointermove",t,{capture:!0})}},[]),(0,r.jsx)(er.Root,{...l,children:(0,r.jsx)(e8,{scope:t,open:a,onOpenChange:p,content:h,onContentChange:u,children:(0,r.jsx)(te,{scope:t,onClose:c.useCallback(()=>p(!1),[p]),isUsingKeyboardRef:d,dir:m,modal:s,children:o})})})};ta.displayName=e0;var to=c.forwardRef((e,t)=>{let{__scopeMenu:a,...o}=e,i=e9(a);return(0,r.jsx)(er.Anchor,{...i,...o,ref:t})});to.displayName="MenuAnchor";var ti="MenuPortal",[tn,ts]=e3(ti,{forceMount:void 0}),tr=e=>{let{__scopeMenu:t,forceMount:a,children:o,container:i}=e,n=e7(ti,t);return(0,r.jsx)(tn,{scope:t,forceMount:a,children:(0,r.jsx)(eh.Presence,{present:a||n.open,children:(0,r.jsx)(el.Portal,{asChild:!0,container:i,children:o})})})};tr.displayName=ti;var tl="MenuContent",[th,tu]=e3(tl),td=c.forwardRef((e,t)=>{let a=ts(tl,e.__scopeMenu),{forceMount:o=a.forceMount,...i}=e,n=e7(tl,e.__scopeMenu),s=tt(tl,e.__scopeMenu);return(0,r.jsx)(e1.Provider,{scope:e.__scopeMenu,children:(0,r.jsx)(eh.Presence,{present:o||n.open,children:(0,r.jsx)(e1.Slot,{scope:e.__scopeMenu,children:s.modal?(0,r.jsx)(tc,{...i,ref:t}):(0,r.jsx)(tp,{...i,ref:t})})})})}),tc=c.forwardRef((e,t)=>{let a=e7(tl,e.__scopeMenu),o=c.useRef(null),i=(0,T.useComposedRefs)(t,o);return c.useEffect(()=>{let e=o.current;if(e)return(0,ep.hideOthers)(e)},[]),(0,r.jsx)(ty,{...e,ref:i,trapFocus:a.open,disableOutsidePointerEvents:a.open,disableOutsideScroll:!0,onFocusOutside:(0,ea.composeEventHandlers)(e.onFocusOutside,e=>e.preventDefault(),{checkForDefaultPrevented:!1}),onDismiss:()=>a.onOpenChange(!1)})}),tp=c.forwardRef((e,t)=>{let a=e7(tl,e.__scopeMenu);return(0,r.jsx)(ty,{...e,ref:t,trapFocus:!1,disableOutsidePointerEvents:!1,disableOutsideScroll:!1,onDismiss:()=>a.onOpenChange(!1)})}),tm=((s=c.forwardRef((e,t)=>{let{children:a,...o}=e;if(c.isValidElement(a)){var i;let e,n,s=(i=a,(n=(e=Object.getOwnPropertyDescriptor(i.props,"ref")?.get)&&"isReactWarning"in e&&e.isReactWarning)?i.ref:(n=(e=Object.getOwnPropertyDescriptor(i,"ref")?.get)&&"isReactWarning"in e&&e.isReactWarning)?i.props.ref:i.props.ref||i.ref),r=function(e,t){let a={...t};for(let o in t){let i=e[o],n=t[o];/^on[A-Z]/.test(o)?i&&n?a[o]=(...e)=>{let t=n(...e);return i(...e),t}:i&&(a[o]=i):"style"===o?a[o]={...i,...n}:"className"===o&&(a[o]=[i,n].filter(Boolean).join(" "))}return{...e,...a}}(o,a.props);return a.type!==c.Fragment&&(r.ref=t?(0,T.composeRefs)(t,s):s),c.cloneElement(a,r)}return c.Children.count(a)>1?c.Children.only(null):null})).displayName="MenuContent.ScrollLock.SlotClone",o=s,(i=c.forwardRef((e,t)=>{let{children:a,...i}=e,n=c.Children.toArray(a),s=n.find(e$);if(s){let e=s.props.children,a=n.map(t=>t!==s?t:c.Children.count(e)>1?c.Children.only(null):c.isValidElement(e)?e.props.children:null);return(0,r.jsx)(o,{...i,ref:t,children:c.isValidElement(e)?c.cloneElement(e,void 0,a):null})}return(0,r.jsx)(o,{...i,ref:t,children:a})})).displayName="MenuContent.ScrollLock.Slot",i),ty=c.forwardRef((e,t)=>{let{__scopeMenu:a,loop:o=!1,trapFocus:i,onOpenAutoFocus:n,onCloseAutoFocus:s,disableOutsidePointerEvents:l,onEntryFocus:h,onEscapeKeyDown:u,onPointerDownOutside:d,onFocusOutside:p,onInteractOutside:m,onDismiss:y,disableOutsideScroll:g,...f}=e,w=e7(tl,a),b=tt(tl,a),v=e9(a),k=e6(a),x=e5(a),[I,S]=c.useState(null),A=c.useRef(null),C=(0,T.useComposedRefs)(t,A,w.onContentChange),q=c.useRef(0),W=c.useRef(""),E=c.useRef(0),M=c.useRef(null),j=c.useRef("right"),R=c.useRef(0),P=g?em.RemoveScroll:c.Fragment;c.useEffect(()=>()=>window.clearTimeout(q.current),[]),(0,en.useFocusGuards)();let z=c.useCallback(e=>{var t,a;return j.current===M.current?.side&&(t=e,!!(a=M.current?.area)&&function(e,t){let{x:a,y:o}=e,i=!1;for(let e=0,n=t.length-1;e<t.length;n=e++){let s=t[e],r=t[n],l=s.x,h=s.y,u=r.x,d=r.y;h>o!=d>o&&a<(u-l)*(o-h)/(d-h)+l&&(i=!i)}return i}({x:t.clientX,y:t.clientY},a))},[]);return(0,r.jsx)(th,{scope:a,searchRef:W,onItemEnter:c.useCallback(e=>{z(e)&&e.preventDefault()},[z]),onItemLeave:c.useCallback(e=>{z(e)||(A.current?.focus(),S(null))},[z]),onTriggerLeave:c.useCallback(e=>{z(e)&&e.preventDefault()},[z]),pointerGraceTimerRef:E,onPointerGraceIntentChange:c.useCallback(e=>{M.current=e},[]),children:(0,r.jsx)(P,{...g?{as:tm,allowPinchZoom:!0}:void 0,children:(0,r.jsx)(es.FocusScope,{asChild:!0,trapped:i,onMountAutoFocus:(0,ea.composeEventHandlers)(n,e=>{e.preventDefault(),A.current?.focus({preventScroll:!0})}),onUnmountAutoFocus:s,children:(0,r.jsx)(ei.DismissableLayer,{asChild:!0,disableOutsidePointerEvents:l,onEscapeKeyDown:u,onPointerDownOutside:d,onFocusOutside:p,onInteractOutside:m,onDismiss:y,children:(0,r.jsx)(eU.Root,{asChild:!0,...k,dir:b.dir,orientation:"vertical",loop:o,currentTabStopId:I,onCurrentTabStopIdChange:S,onEntryFocus:(0,ea.composeEventHandlers)(h,e=>{b.isUsingKeyboardRef.current||e.preventDefault()}),preventScrollOnEntryFocus:!0,children:(0,r.jsx)(er.Content,{role:"menu","aria-orientation":"vertical","data-state":tO(w.open),"data-radix-menu-content":"",dir:b.dir,...v,...f,ref:C,style:{outline:"none",...f.style},onKeyDown:(0,ea.composeEventHandlers)(f.onKeyDown,e=>{let t=e.target.closest("[data-radix-menu-content]")===e.currentTarget,a=e.ctrlKey||e.altKey||e.metaKey,o=1===e.key.length;if(t){var i;let t,n,s,r,l,h;"Tab"===e.key&&e.preventDefault(),!a&&o&&(i=e.key,t=W.current+i,n=x().filter(e=>!e.disabled),s=document.activeElement,r=n.find(e=>e.ref.current===s)?.textValue,l=function(e,t,a){var o;let i=t.length>1&&Array.from(t).every(e=>e===t[0])?t[0]:t,n=a?e.indexOf(a):-1,s=(o=Math.max(n,0),e.map((t,a)=>e[(o+a)%e.length]));1===i.length&&(s=s.filter(e=>e!==a));let r=s.find(e=>e.toLowerCase().startsWith(i.toLowerCase()));return r!==a?r:void 0}(n.map(e=>e.textValue),t,r),h=n.find(e=>e.textValue===l)?.ref.current,function e(t){W.current=t,window.clearTimeout(q.current),""!==t&&(q.current=window.setTimeout(()=>e(""),1e3))}(t),h&&setTimeout(()=>h.focus()))}let n=A.current;if(e.target!==n||!eZ.includes(e.key))return;e.preventDefault();let s=x().filter(e=>!e.disabled).map(e=>e.ref.current);eJ.includes(e.key)&&s.reverse(),function(e){let t=document.activeElement;for(let a of e)if(a===t||(a.focus(),document.activeElement!==t))return}(s)}),onBlur:(0,ea.composeEventHandlers)(e.onBlur,e=>{e.currentTarget.contains(e.target)||(window.clearTimeout(q.current),W.current="")}),onPointerMove:(0,ea.composeEventHandlers)(e.onPointerMove,tG(e=>{let t=e.target,a=R.current!==e.clientX;e.currentTarget.contains(t)&&a&&(j.current=e.clientX>R.current?"right":"left",R.current=e.clientX)}))})})})})})})});td.displayName=tl;var tg=c.forwardRef((e,t)=>{let{__scopeMenu:a,...o}=e;return(0,r.jsx)(v.Primitive.div,{role:"group",...o,ref:t})});tg.displayName="MenuGroup";var tf=c.forwardRef((e,t)=>{let{__scopeMenu:a,...o}=e;return(0,r.jsx)(v.Primitive.div,{...o,ref:t})});tf.displayName="MenuLabel";var tw="MenuItem",tb="menu.itemSelect",tv=c.forwardRef((e,t)=>{let{disabled:a=!1,onSelect:o,...i}=e,n=c.useRef(null),s=tt(tw,e.__scopeMenu),l=tu(tw,e.__scopeMenu),h=(0,T.useComposedRefs)(t,n),u=c.useRef(!1);return(0,r.jsx)(tk,{...i,ref:h,disabled:a,onClick:(0,ea.composeEventHandlers)(e.onClick,()=>{let e=n.current;if(!a&&e){let t=new CustomEvent(tb,{bubbles:!0,cancelable:!0});e.addEventListener(tb,e=>o?.(e),{once:!0}),(0,v.dispatchDiscreteCustomEvent)(e,t),t.defaultPrevented?u.current=!1:s.onClose()}}),onPointerDown:t=>{e.onPointerDown?.(t),u.current=!0},onPointerUp:(0,ea.composeEventHandlers)(e.onPointerUp,e=>{u.current||e.currentTarget?.click()}),onKeyDown:(0,ea.composeEventHandlers)(e.onKeyDown,e=>{let t=""!==l.searchRef.current;a||t&&" "===e.key||eK.includes(e.key)&&(e.currentTarget.click(),e.preventDefault())})})});tv.displayName=tw;var tk=c.forwardRef((e,t)=>{let{__scopeMenu:a,disabled:o=!1,textValue:i,...n}=e,s=tu(tw,a),l=e6(a),h=c.useRef(null),u=(0,T.useComposedRefs)(t,h),[d,p]=c.useState(!1),[m,y]=c.useState("");return c.useEffect(()=>{let e=h.current;e&&y((e.textContent??"").trim())},[n.children]),(0,r.jsx)(e1.ItemSlot,{scope:a,disabled:o,textValue:i??m,children:(0,r.jsx)(eU.Item,{asChild:!0,...l,focusable:!o,children:(0,r.jsx)(v.Primitive.div,{role:"menuitem","data-highlighted":d?"":void 0,"aria-disabled":o||void 0,"data-disabled":o?"":void 0,...n,ref:u,onPointerMove:(0,ea.composeEventHandlers)(e.onPointerMove,tG(e=>{o?s.onItemLeave(e):(s.onItemEnter(e),e.defaultPrevented||e.currentTarget.focus({preventScroll:!0}))})),onPointerLeave:(0,ea.composeEventHandlers)(e.onPointerLeave,tG(e=>s.onItemLeave(e))),onFocus:(0,ea.composeEventHandlers)(e.onFocus,()=>p(!0)),onBlur:(0,ea.composeEventHandlers)(e.onBlur,()=>p(!1))})})})}),tT=c.forwardRef((e,t)=>{let{checked:a=!1,onCheckedChange:o,...i}=e;return(0,r.jsx)(tE,{scope:e.__scopeMenu,checked:a,children:(0,r.jsx)(tv,{role:"menuitemcheckbox","aria-checked":tL(a)?"mixed":a,...i,ref:t,"data-state":tY(a),onSelect:(0,ea.composeEventHandlers)(i.onSelect,()=>o?.(!!tL(a)||!a),{checkForDefaultPrevented:!1})})})});tT.displayName="MenuCheckboxItem";var tx="MenuRadioGroup",[tI,tS]=e3(tx,{value:void 0,onValueChange:()=>{}}),tA=c.forwardRef((e,t)=>{let{value:a,onValueChange:o,...i}=e,n=(0,eV.useCallbackRef)(o);return(0,r.jsx)(tI,{scope:e.__scopeMenu,value:a,onValueChange:n,children:(0,r.jsx)(tg,{...i,ref:t})})});tA.displayName=tx;var tC="MenuRadioItem",tq=c.forwardRef((e,t)=>{let{value:a,...o}=e,i=tS(tC,e.__scopeMenu),n=a===i.value;return(0,r.jsx)(tE,{scope:e.__scopeMenu,checked:n,children:(0,r.jsx)(tv,{role:"menuitemradio","aria-checked":n,...o,ref:t,"data-state":tY(n),onSelect:(0,ea.composeEventHandlers)(o.onSelect,()=>i.onValueChange?.(a),{checkForDefaultPrevented:!1})})})});tq.displayName=tC;var tW="MenuItemIndicator",[tE,tM]=e3(tW,{checked:!1}),tj=c.forwardRef((e,t)=>{let{__scopeMenu:a,forceMount:o,...i}=e,n=tM(tW,a);return(0,r.jsx)(eh.Presence,{present:o||tL(n.checked)||!0===n.checked,children:(0,r.jsx)(v.Primitive.span,{...i,ref:t,"data-state":tY(n.checked)})})});tj.displayName=tW;var tR=c.forwardRef((e,t)=>{let{__scopeMenu:a,...o}=e;return(0,r.jsx)(v.Primitive.div,{role:"separator","aria-orientation":"horizontal",...o,ref:t})});tR.displayName="MenuSeparator";var tP=c.forwardRef((e,t)=>{let{__scopeMenu:a,...o}=e,i=e9(a);return(0,r.jsx)(er.Arrow,{...i,...o,ref:t})});tP.displayName="MenuArrow";var[tz,tH]=e3("MenuSub"),tD="MenuSubTrigger",tN=c.forwardRef((e,t)=>{let a=e7(tD,e.__scopeMenu),o=tt(tD,e.__scopeMenu),i=tH(tD,e.__scopeMenu),n=tu(tD,e.__scopeMenu),s=c.useRef(null),{pointerGraceTimerRef:l,onPointerGraceIntentChange:h}=n,u={__scopeMenu:e.__scopeMenu},d=c.useCallback(()=>{s.current&&window.clearTimeout(s.current),s.current=null},[]);return c.useEffect(()=>d,[d]),c.useEffect(()=>{let e=l.current;return()=>{window.clearTimeout(e),h(null)}},[l,h]),(0,r.jsx)(to,{asChild:!0,...u,children:(0,r.jsx)(tk,{id:i.triggerId,"aria-haspopup":"menu","aria-expanded":a.open,"aria-controls":i.contentId,"data-state":tO(a.open),...e,ref:(0,T.composeRefs)(t,i.onTriggerChange),onClick:t=>{e.onClick?.(t),e.disabled||t.defaultPrevented||(t.currentTarget.focus(),a.open||a.onOpenChange(!0))},onPointerMove:(0,ea.composeEventHandlers)(e.onPointerMove,tG(t=>{n.onItemEnter(t),!t.defaultPrevented&&(e.disabled||a.open||s.current||(n.onPointerGraceIntentChange(null),s.current=window.setTimeout(()=>{a.onOpenChange(!0),d()},100)))})),onPointerLeave:(0,ea.composeEventHandlers)(e.onPointerLeave,tG(e=>{d();let t=a.content?.getBoundingClientRect();if(t){let o=a.content?.dataset.side,i="right"===o,s=t[i?"left":"right"],r=t[i?"right":"left"];n.onPointerGraceIntentChange({area:[{x:e.clientX+(i?-5:5),y:e.clientY},{x:s,y:t.top},{x:r,y:t.top},{x:r,y:t.bottom},{x:s,y:t.bottom}],side:o}),window.clearTimeout(l.current),l.current=window.setTimeout(()=>n.onPointerGraceIntentChange(null),300)}else{if(n.onTriggerLeave(e),e.defaultPrevented)return;n.onPointerGraceIntentChange(null)}})),onKeyDown:(0,ea.composeEventHandlers)(e.onKeyDown,t=>{let i=""!==n.searchRef.current;e.disabled||i&&" "===t.key||eQ[o.dir].includes(t.key)&&(a.onOpenChange(!0),a.content?.focus(),t.preventDefault())})})})});tN.displayName=tD;var tB="MenuSubContent",tF=c.forwardRef((e,t)=>{let a=ts(tl,e.__scopeMenu),{forceMount:o=a.forceMount,...i}=e,n=e7(tl,e.__scopeMenu),s=tt(tl,e.__scopeMenu),l=tH(tB,e.__scopeMenu),h=c.useRef(null),u=(0,T.useComposedRefs)(t,h);return(0,r.jsx)(e1.Provider,{scope:e.__scopeMenu,children:(0,r.jsx)(eh.Presence,{present:o||n.open,children:(0,r.jsx)(e1.Slot,{scope:e.__scopeMenu,children:(0,r.jsx)(ty,{id:l.contentId,"aria-labelledby":l.triggerId,...i,ref:u,align:"start",side:"rtl"===s.dir?"left":"right",disableOutsidePointerEvents:!1,disableOutsideScroll:!1,trapFocus:!1,onOpenAutoFocus:e=>{s.isUsingKeyboardRef.current&&h.current?.focus(),e.preventDefault()},onCloseAutoFocus:e=>e.preventDefault(),onFocusOutside:(0,ea.composeEventHandlers)(e.onFocusOutside,e=>{e.target!==l.trigger&&n.onOpenChange(!1)}),onEscapeKeyDown:(0,ea.composeEventHandlers)(e.onEscapeKeyDown,e=>{s.onClose(),e.preventDefault()}),onKeyDown:(0,ea.composeEventHandlers)(e.onKeyDown,e=>{let t=e.currentTarget.contains(e.target),a=eX[s.dir].includes(e.key);t&&a&&(n.onOpenChange(!1),l.trigger?.focus(),e.preventDefault())})})})})})});function tO(e){return e?"open":"closed"}function tL(e){return"indeterminate"===e}function tY(e){return tL(e)?"indeterminate":e?"checked":"unchecked"}function tG(e){return t=>"mouse"===t.pointerType?e(t):void 0}tF.displayName=tB;var tU="DropdownMenu",[t_,t$]=(0,eo.createContextScope)(tU,[e4]),tV=e4(),[tK,tJ]=t_(tU),tZ=e=>{let{__scopeDropdownMenu:t,children:a,dir:o,open:i,defaultOpen:n,onOpenChange:s,modal:l=!0}=e,h=tV(t),u=c.useRef(null),[d,p]=(0,ec.useControllableState)({prop:i,defaultProp:n??!1,onChange:s,caller:tU});return(0,r.jsx)(tK,{scope:t,triggerId:(0,k.useId)(),triggerRef:u,contentId:(0,k.useId)(),open:d,onOpenChange:p,onOpenToggle:c.useCallback(()=>p(e=>!e),[p]),modal:l,children:(0,r.jsx)(ta,{...h,open:d,onOpenChange:p,dir:o,modal:l,children:a})})};tZ.displayName=tU;var tQ="DropdownMenuTrigger",tX=c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,disabled:o=!1,...i}=e,n=tJ(tQ,a),s=tV(a);return(0,r.jsx)(to,{asChild:!0,...s,children:(0,r.jsx)(v.Primitive.button,{type:"button",id:n.triggerId,"aria-haspopup":"menu","aria-expanded":n.open,"aria-controls":n.open?n.contentId:void 0,"data-state":n.open?"open":"closed","data-disabled":o?"":void 0,disabled:o,...i,ref:(0,T.composeRefs)(t,n.triggerRef),onPointerDown:(0,ea.composeEventHandlers)(e.onPointerDown,e=>{!o&&0===e.button&&!1===e.ctrlKey&&(n.onOpenToggle(),n.open||e.preventDefault())}),onKeyDown:(0,ea.composeEventHandlers)(e.onKeyDown,e=>{!o&&(["Enter"," "].includes(e.key)&&n.onOpenToggle(),"ArrowDown"===e.key&&n.onOpenChange(!0),["Enter"," ","ArrowDown"].includes(e.key)&&e.preventDefault())})})})});tX.displayName=tQ;var t0=e=>{let{__scopeDropdownMenu:t,...a}=e,o=tV(t);return(0,r.jsx)(tr,{...o,...a})};t0.displayName="DropdownMenuPortal";var t1="DropdownMenuContent",t5=c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tJ(t1,a),n=tV(a),s=c.useRef(!1);return(0,r.jsx)(td,{id:i.contentId,"aria-labelledby":i.triggerId,...n,...o,ref:t,onCloseAutoFocus:(0,ea.composeEventHandlers)(e.onCloseAutoFocus,e=>{s.current||i.triggerRef.current?.focus(),s.current=!1,e.preventDefault()}),onInteractOutside:(0,ea.composeEventHandlers)(e.onInteractOutside,e=>{let t=e.detail.originalEvent,a=0===t.button&&!0===t.ctrlKey,o=2===t.button||a;(!i.modal||o)&&(s.current=!0)}),style:{...e.style,"--radix-dropdown-menu-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-dropdown-menu-content-available-width":"var(--radix-popper-available-width)","--radix-dropdown-menu-content-available-height":"var(--radix-popper-available-height)","--radix-dropdown-menu-trigger-width":"var(--radix-popper-anchor-width)","--radix-dropdown-menu-trigger-height":"var(--radix-popper-anchor-height)"}})});t5.displayName=t1,c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tg,{...i,...o,ref:t})}).displayName="DropdownMenuGroup",c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tf,{...i,...o,ref:t})}).displayName="DropdownMenuLabel";var t2=c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tv,{...i,...o,ref:t})});function t3({...e}){return(0,r.jsx)(tZ,{"data-slot":"dropdown-menu",...e})}function t4({...e}){return(0,r.jsx)(tX,{"data-slot":"dropdown-menu-trigger",...e})}function t9({className:e,sideOffset:t=4,...a}){return(0,r.jsx)(t0,{children:(0,r.jsx)(t5,{"data-slot":"dropdown-menu-content",sideOffset:t,className:(0,K.cn)("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md",e),...a})})}function t6({className:e,inset:t,variant:a="default",...o}){return(0,r.jsx)(t2,{"data-slot":"dropdown-menu-item","data-inset":t,"data-variant":a,className:(0,K.cn)("focus:bg-accent focus:text-accent-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 dark:data-[variant=destructive]:focus:bg-destructive/20 data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:*:[svg]:!text-destructive [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",e),...o})}t2.displayName="DropdownMenuItem",c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tT,{...i,...o,ref:t})}).displayName="DropdownMenuCheckboxItem",c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tA,{...i,...o,ref:t})}).displayName="DropdownMenuRadioGroup",c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tq,{...i,...o,ref:t})}).displayName="DropdownMenuRadioItem",c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tj,{...i,...o,ref:t})}).displayName="DropdownMenuItemIndicator",c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tR,{...i,...o,ref:t})}).displayName="DropdownMenuSeparator",c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tP,{...i,...o,ref:t})}).displayName="DropdownMenuArrow",c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tN,{...i,...o,ref:t})}).displayName="DropdownMenuSubTrigger",c.forwardRef((e,t)=>{let{__scopeDropdownMenu:a,...o}=e,i=tV(a);return(0,r.jsx)(tF,{...i,...o,ref:t,style:{...e.style,"--radix-dropdown-menu-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-dropdown-menu-content-available-width":"var(--radix-popper-available-width)","--radix-dropdown-menu-content-available-height":"var(--radix-popper-available-height)","--radix-dropdown-menu-trigger-width":"var(--radix-popper-anchor-width)","--radix-dropdown-menu-trigger-height":"var(--radix-popper-anchor-height)"}})}).displayName="DropdownMenuSubContent",e.i(78784),(0,l.default)("chevron-right",[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]]),e.i(33498);var t8=e.i(95926);function t7({...e}){return(0,r.jsx)(b.Root,{"data-slot":"sheet",...e})}function ae({...e}){return(0,r.jsx)(b.Trigger,{"data-slot":"sheet-trigger",...e})}function at({...e}){return(0,r.jsx)(b.Portal,{"data-slot":"sheet-portal",...e})}function aa({className:e,...t}){return(0,r.jsx)(b.Overlay,{"data-slot":"sheet-overlay",className:(0,K.cn)("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/50",e),...t})}function ao({className:e,children:t,side:a="right",...o}){return(0,r.jsxs)(at,{children:[(0,r.jsx)(aa,{}),(0,r.jsxs)(b.Content,{"data-slot":"sheet-content",className:(0,K.cn)("bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500","right"===a&&"data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-3/4 border-l sm:max-w-sm","left"===a&&"data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-3/4 border-r sm:max-w-sm","top"===a&&"data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top inset-x-0 top-0 h-auto border-b","bottom"===a&&"data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 h-auto border-t",e),...o,children:[t,(0,r.jsxs)(b.Close,{className:"ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none",children:[(0,r.jsx)(t8.XIcon,{className:"size-4"}),(0,r.jsx)("span",{className:"sr-only",children:"Close"})]})]})]})}function ai({className:e,...t}){return(0,r.jsx)(b.Title,{"data-slot":"sheet-title",className:(0,K.cn)("text-foreground font-semibold",e),...t})}let an=(0,l.default)("calculator",[["rect",{width:"16",height:"20",x:"4",y:"2",rx:"2",key:"1nb95v"}],["line",{x1:"8",x2:"16",y1:"6",y2:"6",key:"x4nwl0"}],["line",{x1:"16",x2:"16",y1:"14",y2:"18",key:"wjye3r"}],["path",{d:"M16 10h.01",key:"1m94wz"}],["path",{d:"M12 10h.01",key:"1nrarc"}],["path",{d:"M8 10h.01",key:"19clt8"}],["path",{d:"M12 14h.01",key:"1etili"}],["path",{d:"M8 14h.01",key:"6423bh"}],["path",{d:"M12 18h.01",key:"mhygvu"}],["path",{d:"M8 18h.01",key:"lrp35t"}]]),as=(0,l.default)("menu",[["path",{d:"M4 5h16",key:"1tepv9"}],["path",{d:"M4 12h16",key:"1lakjw"}],["path",{d:"M4 19h16",key:"1djgab"}]]);var ar=e.i(22016);function al(){let[e,t]=(0,c.useState)(!1);return(0,r.jsx)("nav",{className:"almanac-nav",children:(0,r.jsxs)("div",{className:"almanac-nav-inner",children:[(0,r.jsxs)(ar.default,{href:"/",className:"almanac-brand",children:[(0,r.jsx)(an,{className:"h-5 w-5",style:{color:"var(--accent)"}}),"Docket One"]}),(0,r.jsxs)("div",{className:"almanac-navlinks",style:{marginLeft:"auto",marginRight:8},children:[(0,r.jsx)(ar.default,{href:"/",className:"almanac-navlink hidden md:inline-flex",children:"Home"}),(0,r.jsxs)(t3,{children:[(0,r.jsx)(t4,{asChild:!0,children:(0,r.jsx)("button",{className:"almanac-navlink hidden md:inline-flex",children:"Categories"})}),(0,r.jsx)(t9,{align:"center",className:"almanac-navmenu",children:eF.map(e=>(0,r.jsx)(t6,{asChild:!0,className:"almanac-navmenu-item cursor-pointer",children:(0,r.jsxs)(ar.default,{href:`/calculators/${e.id}/`,children:[(0,r.jsx)("span",{style:{marginRight:8},children:e.emoji}),e.name]})},e.id))})]}),(0,r.jsx)(ar.default,{href:"https://blog.docket.one",className:"almanac-navlink hidden md:inline-flex",children:"Blog"})]}),(0,r.jsxs)("div",{className:"flex items-center gap-3",children:[(0,r.jsx)(eL,{}),(0,r.jsxs)(t7,{open:e,onOpenChange:t,children:[(0,r.jsx)(ae,{asChild:!0,children:(0,r.jsx)("button",{className:"almanac-navlink md:hidden","aria-label":"Open menu",style:{padding:8},children:(0,r.jsx)(as,{className:"h-5 w-5"})})}),(0,r.jsx)(ao,{side:"right",className:"almanac-sheet p-0 overflow-y-auto",children:(0,r.jsxs)("div",{className:"flex flex-col h-full p-8 pt-12",children:[(0,r.jsx)(ai,{asChild:!0,children:(0,r.jsxs)("span",{className:"almanac-sheet-brand",style:{marginBottom:28},children:[(0,r.jsx)(an,{className:"h-6 w-6",style:{color:"var(--accent)"}}),"Docket One"]})}),(0,r.jsxs)("div",{className:"flex flex-col gap-7 flex-1",children:[(0,r.jsxs)("div",{className:"flex flex-col gap-3",children:[(0,r.jsx)("div",{className:"almanac-sheet-label",style:{marginBottom:4},children:"Navigation"}),(0,r.jsxs)(ar.default,{href:"/",onClick:()=>t(!1),className:"almanac-sheet-item",children:[(0,r.jsx)("span",{className:"ic",children:"🏠"}),(0,r.jsx)("span",{className:"t",children:"Home"})]}),(0,r.jsxs)(ar.default,{href:"https://blog.docket.one",onClick:()=>t(!1),className:"almanac-sheet-item",children:[(0,r.jsx)("span",{className:"ic",children:"📰"}),(0,r.jsx)("span",{className:"t",children:"The Calculator Blog"})]})]}),(0,r.jsxs)("div",{className:"flex flex-col gap-3",children:[(0,r.jsx)("div",{className:"almanac-sheet-label",style:{marginBottom:4},children:"Collections"}),eF.map(e=>(0,r.jsxs)(ar.default,{href:`/calculators/${e.id}/`,onClick:()=>t(!1),className:"almanac-sheet-item",children:[(0,r.jsx)("span",{className:"ic",children:e.emoji}),(0,r.jsx)("span",{className:"t",children:e.name})]},e.id))]})]})]})})]})]})]})})}e.s(["NavBar",()=>al],65890)}]);